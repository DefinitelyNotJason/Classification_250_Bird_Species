...
# 5) Data preprocessing & Data transformation
# using vgg16 mode to preprocess the input observation
train_gen = ImageDataGenerator(preprocessing_function=preprocess_input, rotation_range=10,
